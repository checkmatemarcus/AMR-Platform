export const bacterial_answer = `Imagine you're in a room with a bunch of mischievous mice and you have a mousetrap that can catch most of them. Over time, a few mice learn how to evade or escape from the trap. These smart mice then have baby mice, and their babies also learn how to avoid the trap. Eventually, you'll have a room full of mice,  and your once-effective mousetrap can't catch any of them. The mice have become 'resistant' to your mousetrap. Now, let's relate this to bacteria.
...
export const resistant_answer = `Imagine you have a lock on your front door to keep out unwanted guests. One day, a sneaky thief learns how to pick your lock and get inside. If you keep using the same lock, the thief will keep getting in because he's learned how to beat it. The thief has become "resistant" to your lock. Similarly, when you get sick, the medicine is like a lock that keeps out the "thieves" (harmful bacteria). But if the bacteria learn how to beat the medicine, just like the thief learned to pick the lock, then that medicine might not work well anymore.

The important thing to remember is that it's not you that becomes resistant; it's the harmful bacteria inside you. When a medicine doesn't work as well as it used to, it might mean the bacteria have figured out how to "pick the lock."To help our "locks" (medicines) work effectively, it's crucial to use them correctly, as prescribed by a doctor.`;

export const tell_doctor = `Imagine you're baking cookies and someone else offers to help you finish. But you forget to tell them you've already added sugar. If they add sugar again without knowing, the cookies will be too sweet and might not taste right.
Similarly, when you visit a doctor, iimport { bacterial_answer, resistant_answer, positive_resistance, prevent_answer } from './constants';t's like starting a new batch of cookies. If you don't tell them what "ingredients" (or medicines) you've already taken, they might give you something that doesn't mix well with what you had before. It's especially important to mention any problems or "bad reactions" you had, just like you'd tell someone if a certain ingredient made your cookies taste odd.
...
export const prevent_answer = `Imagine your favorite toy as a kid. If you played with it too much and in ways 
it wasn't designed for, it might break or wear out faster. Similarly, antibiotics are powerful "tools" 
in medicine. If we use them too often or not as intended, they might not work as effectively in the 
future because bacteria learn how to "dodge" them.
